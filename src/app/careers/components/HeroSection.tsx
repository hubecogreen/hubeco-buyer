...
<div className="absolute inset-x-0 top-[78px] px-[24px] sm:px-6 md:top-[40px] md:px-8 md:py-0 lg:left-[100px] lg:right-auto lg:top-[84px] lg:px-0 lg:py-0">          
  <div className="flex w-full max-w-[854px] flex-col gap-6 md:gap-[14px] pr-0 text-cream lg:gap-[32px]  lg:pr-[24px]">
