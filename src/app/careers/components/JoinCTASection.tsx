    ...
    <section className="w-full flex justify-center bg-cream py-[40px]">
      ...
      <div className="relative w-[1232px] h-[518px] rounded-[48px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-[232px] py-[96px]">
          ...
          {/* DESCRIPTION */}
          <p className="mt-[16px] mb-[8px] text-cream text-[20px] leading-[32.5px] font-medium w-[922px] ">
            Ready to make an impact in green building, sustainable materials and <br/>
            construction technology? At Hubeco, you’ll work on real-world problems <br/>
