            ...
            >
              <span className="font-family:Poppins;font-size:6.0pt;">
                <span dir="ltr" lang="EN-GB" className="line-height:115%;">
                  PRIVACY POLICY AS UPDATED ON August 1, 2025
                </span>
              </span>
            </p>
                      ...
                      <li className="md:pl-14 pl-8">
                        <p className="line-height:115%;margin-bottom:0.0001pt;margin-right:0in;margin-top:0in;text-align:justify;">
                          ...
                          <span className="font-family:Poppins;font-size:6.0pt;">
                            ...
                            >
                              <strong className="pr-2">
                                <u>Financing‑Related Information:</u>
                              </strong>
                              When applying for any green home loan or project
                              finance, we will collect additional personal,
                              financial, and project‑related data to facilitate
                              your application. This may include, but is not
                              limited to, identity proofs, property documents,
                              project details, financial statements, or any
                              other relevant information. Please note that we
                              collect, share, and process such information only
                              after your express written consent.
                            </span>
                          </span>
                        </p>
                      </li>
                ...
                <ol className="list-className-type:none;padding-left:48px;">
                  <li className="md:pl-8 pl-4">
                    ...
                    <ol className="list-className-type:none;padding-left:74.07px;">
                      ...
                      <li className="md:pl-14 pl-8">
                        <p className="line-height:115%;margin-bottom:0.0001pt;margin-right:0in;margin-top:0in;text-align:justify;">
                          ...
                          <span className="font-family:Poppins;font-size:6.0pt;">
                            ...
                            >
                              <strong className="pr-2">
                                <u>Facilitating Financing Services:</u>
                              </strong>
                              If you elect to explore green home loans or
                              project finance through the Platform, we collect
                              and process your personal, financial, and
                              project-related information for the limited
                              purpose of facilitating introductions to our
                              third-party financing partners. This includes
                              sharing relevant data to help assess your
                              eligibility, enable application processing, and
                              assist you in availing financing opportunities
                              through such partners. We do not underwrite or
                              provide any financing ourselves, and our role is
                              strictly limited to facilitating such
                              introductions based on your explicit consent.
                            </span>
                          </span>
                        </p>
                      </li>
                      ...
                      <li className="md:pl-14 pl-8">
                        <p className="line-height:115%;margin-bottom:0.0001pt;margin-right:0in;margin-top:0in;text-align:justify;">
                          <span className="pr-2">4.1.12.</span>
                          <span className="font-family:Poppins;font-size:6.0pt;">
                            <span
                              dir="ltr"
                              lang="EN-GB"
                    ...
                    <ol className="list-className-type:none;padding-left:74.07px;">
                      ...
                      <li className="md:pl-14 pl-8">
                        <p className="line-height:115%;margin-bottom:0.0001pt;margin-right:0in;margin-top:0in;text-align:justify;">
                          ...
                          <span className="font-family:Poppins;font-size:6.0pt;">
                            ...
                            >
                              <strong className="pr-2">
                                <u>Financing Partners:</u>
                              </strong>
                              We may share your personal, financial, and
                              project-related data (such as identity and contact
                              details, income proofs, property documentation,
                              and transaction history) with our authorised
                              third-party financing partners solely for the
                              purpose of evaluating and processing your
                              financing request. This sharing is done only upon
                              your express consent and is subject to applicable
                              data protection laws. These partners will
                              independently handle your information in
                              accordance with their own privacy policies and are
                              responsible for the subsequent use, processing, or
                              retention of such data. We do not control or
                              influence their decision-making or service terms.
                            </span>
                          </span>
                        </p>
                      </li>
                        ...
                        <p className="line-height:115%;margin-bottom:0.0001pt;margin-right:0in;margin-top:0in;text-align:justify;">
                          ...
                          <span className="font-family:Poppins;font-size:6.0pt;">
                            ...
                            >
                              ...
                              with these providers a nd utilise their services,
                      ...
                      <li className="md:pl-14 pl-8">
                        ...
                        <ol className="list-className-type:none;padding-left:21.93px;">
                          <li className="md:pl-20 pl-10">
                            <p className="line-height:115%;margin-bottom:0.0001pt;margin-right:0in;margin-top:0in;text-align:justify;">
                              <span className="pr-2">5.1.6.1.</span>
                              <span className="font-family:Poppins;font-size:6.0pt;">
                                <span
                                  dir="ltr"
                                  lang="EN-GB"
                          ...
                          <li className="md:pl-20 pl-10">
                            <p className="line-height:115%;margin-bottom:0.0001pt;margin-right:0in;margin-top:0in;text-align:justify;">
                              <span className="pr-2">5.1.6.2.</span>
                              <span className="font-family:Poppins;font-size:6.0pt;">
                                <span
                                  dir="ltr"
                                  lang="EN-GB"
                          ...
                          <li className="md:pl-20 pl-10">
                            <p className="line-height:115%;margin-bottom:0.0001pt;margin-right:0in;margin-top:0in;text-align:justify;">
                              <span className="pr-2">5.1.6.3.</span>
                              <span className="font-family:Poppins;font-size:6.0pt;">
                                <span
                                  dir="ltr"
                                  lang="EN-GB"
                      ...
                      <li className="md:pl-14 pl-8">
                        <p className="line-height:115%;margin-bottom:0.0001pt;margin-right:0in;margin-top:0in;text-align:justify;">
                          <span className="pr-2">5.1.10.</span>
                          <span className="font-family:Poppins;font-size:6.0pt;">
                            <span
                              dir="ltr"
                              lang="EN-GB"
