            ...
            {blogData ? (
              <>
                ...
                <div>
                  ...
                  <div>
                    <div className={`${styles.contentWrapper} prose prose-lg [&_ul]:list-disc [&_ul]:pb-2 text-left md:text-left text-sm lg:text-sm xl:text-sm w-full lg:pt-10 pt-5 prose prose-lg xl:prose-xl hover:prose-a:text-brand`}
