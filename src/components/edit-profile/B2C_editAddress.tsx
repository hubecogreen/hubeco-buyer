...
const B2C_editAddress: React.FC<AddressFormProps> = ({ nextStep }) => {
  ...
  const handleAddApiError = async (err: any, data: any) => {
    const result = err && err.response as any;
    ...
    if (addId) {
      try {
        const result = (await callApi(
          `${getEndpoint.default.UPDATEADDRESS}/${addId}`,
          "PUT",
          payload
        )) as any;
        if (result.data == null) {
  ...
  const deleteAddress = async (id: any) => {
    ...
    try {
      const result = await callApi(
        `${getEndpoint.default.DELETEADDRESS}/${deleteId}`,
        "DELETE"
      );
  ...
  const onEditAddress = (address: any) => {
    // // console.log('vwijrej',address['state'],address['city'],address['country']);
    if (address?.address.includes("|") && address.landmark == null) {
        ...
        <div>
          ...
          {!isFormVisible && (
            <div>
              <button
                onClick={toggleForm}
                className="bg-secondary rounded-md text-white p-3 hover:bg-primary block ml-0"
              >
          ...
          {isFormVisible && (
            <>
              <Button
                className="bg-secondary hover:bg-primary h-[45px] md:h-[45px] md:w-48  w-48 px-2 md:text-md text-sm text-white flex items-center justify-center"
              ...
              >
                {loading ? (
                  ...
                  <>
                    <MdMyLocation color="white" size={20} className="mr-2" />{" "}
              ...
              >
                  ...
                  <div className="md:w-3/6 w-full p-5">
                    ...
                    <Controller
                      ...
                      render={({ field: { onChange, value } }) => (
                        <Select
                          onValueChange={(e) => {
                            onChangeCountry(e, "dropdown"), onChange(e);
                          }}
                          value={value}
                        >
                  ...
                  <div className="md:w-3/6 w-full p-5">
                    ...
                    <Controller
                      ...
                      render={({ field: { onChange, value } }) => (
                        <Select
                          onValueChange={(e: any) => {
                            onChangeState(e, "dropdown"), onChange(e);
                          }}
                          value={value}
                        >
                          <SelectTrigger className="w-full">
                ...
                <div className="flex p-5">
                  <CustomButton
                    title={"Cancel"}
                    className="ml-3 bg-lightGray   h-12 md:h-12 md:w-36 w-fit md:text-md text-sm text-white"
                  ...
                  <CustomButton
                    title={"Submit"}
                    className="ml-3 bg-secondary hover:bg-primary h-12 md:h-12 md:w-48 w-fit md:text-md text-sm text-white"
                    customStyles={{}}
                    // onPress={onSubmit}
                    type="submit"
                    loading={isLoading}
...
export default B2C_editAddress;
