            ...
            <div className="flex flex-col space-y-4 pt-5">
              <div className="flex items-start items-start mt-4 lg:mt-4">
                ...
                <div className="ml-4 flex flex-col mb-2">
                  ...
                  <p className="text-justify text-sm text-medium mt-2 text-black">
                    Explore our wide range of green building materials, each
                    carefully selected for sustainability and performance.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start items-start">
                ...
                <div className="ml-4 pl-[4px] flex flex-col mb-2">
                  ...
                  <p className="text-justify text-sm text-medium mt-2 text-black">
                    Use our platform to compare products, read green
                    certifications and specifications, read reviews, and select
              ...
              <div className="flex items-start items-start">
                ...
                <div className="ml-3 flex flex-col mb-2">
                  ...
                  <p className="text-justify text-sm text-medium mt-2 text-black">
                    Enjoy a seamless shopping experience with secure payment
                    options and efficient delivery services from the vendors.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start items-start">
                ...
                <div className="ml-4 flex flex-col mb-2">
                  ...
                  <p className="text-justify text-sm text-medium mt-2 text-black">
                    Use our materials to create eco-friendly structures that
            ...
            <div className="flex flex-col space-y-4 pt-5">
              <div className="flex items-start mt-4 lg:mt-4">
                ...
                <div className="ml-4 flex flex-col mb-2">
                  ...
                  <p className="text-justify text-sm text-medium mt-2 text-black">
                    Sign up quickly with our simple registration process to
                    become a vendor on our platform.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4 flex flex-col mb-2">
                  ...
                  <p className="text-justify text-sm text-medium mt-2 text-black">
                    ...
                    sustainability data, product certifications, images and
                    prices.
                  </p>
                </div>
              </div>
