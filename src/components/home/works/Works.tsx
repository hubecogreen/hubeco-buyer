  ...
  <div className="relative z-10  ">
    ...
    <div className="flex gap-3 mt-4 lg:block lg:mt-10 ">
      <CustomButton
        ...
        className={`flex items-center shadow-md shadow-primary justify-center lg:w-[380px] lg:h-[80px] gap-2 rounded-2xl border font-bold w-full py-3 text-[16px]  lg:p-[22px] h-[60px] lg:text-[30px] lg:justify-between mb-0 lg:mb-6 ${
          showBuyer
      ...
      <CustomButton
        ...
        className={`flex items-center justify-center shadow-md shadow-secondary lg:w-[380px] lg:h-[80px] gap-2 rounded-2xl border font-bold w-full py-3 text-[16px]  lg:p-[22px] h-[60px] lg:text-[30px] lg:justify-between ${
          !showBuyer
