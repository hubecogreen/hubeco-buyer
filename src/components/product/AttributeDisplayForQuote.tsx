...
const AttributeDisplayForQuote = ({
  attributes,
  currentAttributes,
      ...
      {Object.entries(parsedAttributes).map(([attributeName, values]: any) => {
        ...
        return (
          <div key={attributeName} className="mb-3">
            ...
            >
              <SelectTrigger className="border border-secondary px-4 py-1 rounded bg-white w-full !text-secondary">
                <SelectValue
...
export default AttributeDisplayForQuote;
