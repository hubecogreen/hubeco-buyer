...
const addressSchema = yup.object({
  ...
  landmark: yup.string().max(75, "Address must be at most 75 characters"),
  city: yup
    .string()
...
const B2BAddress: React.FC<AddressFormProps> = ({
...
// console.log('vfvdvf',shippingInfo)
  ...
  <div className="w-3/6 p-5">
    ...
    />
      ...
      <Checkbox
        ...
        checked={checked}
        color="#A92449"
        className="accent-[#A92449]" // Tailwind for accent color
      />
      <label
        htmlFor="terms"
