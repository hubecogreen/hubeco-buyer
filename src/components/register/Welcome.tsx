        ...
        <div className="flex justify-center">
         ...
         <Lottie animationData={animationData} loop={true} className="w-[300px] h-[300px]" />
          ...
          <div className="text-center">
            ...
            <p className="text-base text-gray-500">Lorem ipsum is placeholder text commonly used in the graphic, print, and <br/>publishing industries for previewing layouts and visual mockups</p>
          </div>
        </div>
