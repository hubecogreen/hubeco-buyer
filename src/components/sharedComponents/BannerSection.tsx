...
function BannerSection({ link1, link2, link3, link4, link5 }: Props) {
  return (
    <div className="banner-section">
      <div className="relative  md:flex block md:justify-start justify-center items-center md:px-20 px-3 bg-[url('/images/about/aboutBanner1.webp')] bg-cover bg-center h-[150px] md:h-[200px] flex items-center justify-start text-white mt-[120px] md:mt-[85px]">
        <Link
          href={link1.href}
